...
HD_PWD='E:/Polaris_519030910245/lab03/lab03.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Ctr.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Ctr.tcl
